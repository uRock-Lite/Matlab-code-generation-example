###########################################################################
## Makefile generated for Simulink model 'Distortion0'. 
## 
## Makefile     : Distortion0.mk
## Generated on : Sun Jan 24 00:51:48 2016
## MATLAB Coder version: 2.7 (R2014b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Distortion0.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\ICLab\Desktop\EMBEDD~1\MATLAB~1\DISTOR~1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ARM Cortex-M
MODELREF_LINK_RSPFILE_NAME = Distortion0_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Distortion0_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Distortion0.exe
...
INCLUDES_BUILDINFO = $(START_DIR)\Distortion0_ert_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=Distortion0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\Distortion0_ert_rtw\Distortion0.c

MAIN_SRC = $(START_DIR)\Distortion0_ert_rtw\ert_main.c
...
{$(START_DIR)\Distortion0_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Distortion0_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
