###########################################################################
## Makefile generated for Simulink model 'Delay0'. 
## 
## Makefile     : Delay0.mk
## Generated on : Sun Jan 24 03:25:58 2016
## MATLAB Coder version: 2.7 (R2014b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Delay0.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\ICLab\Desktop\EMBEDD~1\MATLAB~1\Delay
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ARM Cortex-M
MODELREF_LINK_RSPFILE_NAME = Delay0_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Delay0_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Delay0.exe
...
DEFINES_STANDARD = -DMODEL=Delay0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\Delay0_ert_rtw\Delay0.c $(START_DIR)\Delay0_ert_rtw\Delay0_data.c

MAIN_SRC = $(START_DIR)\Delay0_ert_rtw\ert_main.c
...
OBJS = Delay0.obj Delay0_data.obj
...
{$(START_DIR)\Delay0_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Delay0_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
